...
Sprechererkennungstest: tDCS script for day 2.
...
This is almost identical to day1, except that different stimuli are used, and
...
d1.TEST_NAME = 'tdcs_day2'
d1.TRIALS_THIS_SESSION = d1.ALL_TRIALS[240:480]
